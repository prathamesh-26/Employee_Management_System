    ...
    <div class="form-container">
      <form class="form" action="update">
        ...
        <div class="form-group">
          ...
          <input type="text" id="email" name="eid" value="${emp.eid}" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" id="contact" name="contact" value="${emp.contact}"/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" id="salary" name="salary" value="${emp.salary}"/>
        </div>
        <div class="form-group">
          <label for="addr">Enter Address :- </label>
          <input type="text" id="addr" name="address" value="${emp.address}"/>
        </div>
        <div class="form-group">
          <label for="addr">Enter Username :- </label>
          <input type="text" id="addr" name="username" value="${emp.username}"/>
        </div>
        <div class="form-group">
          <label for="addr">Enter Password :- </label>
          <input type="text" id="addr" name="password" value="${emp.password}"/>
        </div>
